...
from intermode.parameters import readParams
from credentials.credentials import setCredentials
...
parser.add_argument('--imode', action='store_true', help="Starts the interactive input mode")
parser.add_argument('--credentials', action='store_true', help="Set credentials for connection with HPC server")

parser.add_argument("-A", "--account", default="default", help="Account to be charged for resource check")
...
parser.add_argument("-e", "--error", default="error-%j.err", help="File name to store job error messages (sbatch and srun only)")
...
parser.add_argument("-N", "--nodes", type=int, choices=[1], default=1, help="Number of nodes required for job execution")
...
parser.add_argument("-o", "--output", default="output-%j.log", help="File name to store job output (sbatch and srun only)")
...
parser.add_argument("--check", action="store_true", help="Check resources on HPC, genarates and executes batch file")
